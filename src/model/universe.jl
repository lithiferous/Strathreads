...
struct Universe
    ...
    from::TimeType
    thru::TimeType
    function Universe(assets::Vector{String},
                      data::Dict{String, TS},
                      from::TimeType=Dates.Date(0),
                      thru::TimeType=Dates.today())
...
function gather(assets::Vector{String};
                source::Function=Temporal.quandl,
